...
class ExcelsView extends PolymerElement {
  ...
  void loadReporting(Event e) {
    ...
    HttpRequest
        .request(globals.reportingUrl + programId, requestHeaders: header)
        .then((HttpRequest req) {
  ...
  void printMessage(String response) {
    shadowRoot.querySelector('#response').innerHtml =
        ("<br><br><br>><pre>" + response + "</pre>");
  }
}
